...
export declare var BedrockAgentCoreControlServiceException$: StaticErrorSchema;
...
export declare var GetAgentRuntimeEndpointResponse$: StaticStructureSchema;
export declare var GetAgentRuntimeRequest$: StaticStructureSchema;
...
export declare var GetWorkloadIdentityResponse$: StaticStructureSchema;
export declare var GithubOauth2ProviderConfigInput$: StaticStructureSchema;
...
export declare var SemanticExtractionOverride$: StaticStructureSchema;
export declare var SemanticMemoryStrategyInput$: StaticStructureSchema;
...
export declare var UpdateAgentRuntimeEndpointResponse$: StaticStructureSchema;
export declare var UpdateAgentRuntimeRequest$: StaticStructureSchema;
...
export declare var UserPreferenceExtractionOverride$: StaticStructureSchema;
export declare var UserPreferenceMemoryStrategyInput$: StaticStructureSchema;
export declare var UserPreferenceOverrideConfigurationInput$: StaticStructureSchema;
...
export declare var CustomExtractionConfiguration$: StaticUnionSchema;
export declare var CustomExtractionConfigurationInput$: StaticUnionSchema;
...
export declare var ModifyReflectionConfiguration$: StaticUnionSchema;
