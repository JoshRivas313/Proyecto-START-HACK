...
declare const ListGatewayTargetsCommand_base: {
    new (input: ListGatewayTargetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListGatewayTargetsCommandInput, ListGatewayTargetsCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListGatewayTargetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListGatewayTargetsCommandInput, ListGatewayTargetsCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListGatewayTargetsCommand extends ListGatewayTargetsCommand_base {
