...
declare const GetPolicyGenerationCommand_base: {
    new (input: GetPolicyGenerationCommandInput): import("@smithy/smithy-client").CommandImpl<GetPolicyGenerationCommandInput, GetPolicyGenerationCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetPolicyGenerationCommandInput): import("@smithy/smithy-client").CommandImpl<GetPolicyGenerationCommandInput, GetPolicyGenerationCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
