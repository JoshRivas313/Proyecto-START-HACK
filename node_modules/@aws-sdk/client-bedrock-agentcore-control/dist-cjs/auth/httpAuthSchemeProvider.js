...
exports.defaultBedrockAgentCoreControlHttpAuthSchemeParametersProvider = defaultBedrockAgentCoreControlHttpAuthSchemeParametersProvider;
...
const defaultBedrockAgentCoreControlHttpAuthSchemeProvider = (authParameters) => {
    const options = [];
